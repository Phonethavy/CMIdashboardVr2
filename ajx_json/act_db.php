...
if (isset($_GET['year1']) && isset($_GET['year2'])) {
    ...
    $month_str = isset($_GET['month']) ? $_GET['month'] : '';
    $data = [];
...
if ($resultCurrent && $resultnii_nim && $resultPrevious) {
...
'CapitalPreviousYear' => isset($row2['CapitalPreviousYear']) ? (float)str_replace(',', '', $row2['CapitalPreviousYear']) : 0,//  only in December
'All_propertyIPreviousYear' => isset($row2['All_propertyIPreviousYear']) ? (float)str_replace(',', '', $row2['All_propertyIPreviousYear']) : 0, //  only in December
'PreviousYearloan_balance99' => isset($row2['PreviousYearloan_balance99']) ? (float)str_replace(',', '', $row2['PreviousYearloan_balance99']) : 0, //  only in December
];
} else {
...
'sumfix2rate' => 0,
'Quantity' => 0,
'CapitalPreviousYear' => 0, 
'All_propertyIPreviousYear' => 0,
'PreviousYearloan_balance99' => 0,
];
}
