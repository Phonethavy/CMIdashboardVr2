        ...
        $sqlCurrentYear = "SELECT 
             date,
                   ...
                   FORMAT(SUM(CASE 
                    ...
                    FORMAT(SUM(CASE 
                        WHEN gl_code IN ('2131130','2131152','2201300','2201512','2201513','2201521','2201522','2201523','2361110','2361140','2361310','2362300','2362500','2362510','2362600','2388300','2388500','2388800','3301100','3308000')
             ...
             FORMAT(SUM(CASE 
               ...
               FORMAT(SUM(CASE 
                ...
                FROM tbl_atc
                WHERE year(`date`) = '$yearCurrent' AND month(date )= '$month_str'"; // Get data for each month
...
FROM tbl_atc
WHERE  year(`date`) = '$yearPrevious' AND month(date )= '$month_str'"; // Get data for December only
