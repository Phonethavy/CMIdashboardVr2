    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ການລົງທຶນ: ເງິນລົງທືນທັງໝົດ / ທຶນຈົດທະບຽນ ຕ້ອງນ້ອຍກວ່າ</td>
        ...
        <script>
            function calculate6(otherdept11_4, other15_3, drevaluation16_6) {
                ...
                return denominator ? ((otherdept11_4 / denominator) * 100).toFixed(2) : "";
            }
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate6(otherdept11_4, other15_3, drevaluation16_6);
                            roeData.push(roe);
                            labels.push(month);
                    ...
                    if (selectedYear) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    otherdept11_4: `<tr><td>11.4 ໜີ້ຕ້ອງສົ່ງອື່ນໆໃຫ້ທະນາຄານ ແລະ ສະຖາບັນການເງິນອື່ນ</td>`,
                                    other15_3: `<tr><td>15.3 ອື່ນໆ</td>`,
                                    drevaluation16_6: `<tr><td>16.6 ສ່ວນຜິດດ່ຽງຈາກການຕີມູນຄ່າຄືນໃໝ່</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate6(data[month].otherdept11_4, data[month].other15_3, data[month].drevaluation16_6);

                                    rows.otherdept11_4 += `<td>${numberFormat(data[month]. otherdept11_4)}</td>`;
                                    rows.other15_3 += `<td>${numberFormat(data[month].other15_3)}</td>`;
                                    rows.drevaluation16_6 += `<td>${numberFormat(data[month].drevaluation16_6)}</td>`;
