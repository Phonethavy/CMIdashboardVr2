    ...
    <div class="container mt-4">
        ...
        <table id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td data-label="Data Type">ການກູ້ຍືມຈາກພາຍນອກທັງໝົດ / ຍອດສີນເຊື່ອທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</td>
        ...
        <script>
            function calculate5(balance2_3, loan_balance99) {
                ...
                return denominator ? ((balance2_3 / denominator) * 100).toFixed(2) : "";
            }
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate5(balance2_3, loan_balance99);
                            roeData.push(roe);
                            labels.push(month);
                    ...
                    if (selectedYear) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    balance2_3: `<tr><td>2.3 ເງິນໃຫ້ກູ້ຢືມ ແລະ ເງິນລ່ວງໜ້າສຸດທິ</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate5(data[month].balance2_3, data[month].loan_balance99);

                                    rows.balance2_3 += `<td>${numberFormat(data[month]. balance2_3)}</td>`;
