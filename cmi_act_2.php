        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td data-label="Data Type">ອັດຕາສ່ວນທຶນທັງໝົດ / ຊັບສິນທີ່ວາງນ້ຳໜັກຄວາມສ່ຽງ ຕ້ອງຫຼາຍກວ່າ</td>
                    <td data-label="Goal">8%</td>
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate2(Capital16, Capital2_16_7, debt2, loans5, assets8, otherAssets10);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    ...
                                    loans5: `<tr><td>5. ສິນເຊື່ອ ແລະ ເງິນລ່ວງໜ້າໃຫ້ລູກຄ້າສຸດທິ</td>`,
                                    assets8: `<tr><td>8. ຊັບສົມບັດຄົງທີ່ສຸດທິ</td>`,
                                    otherAssets10: `<tr><td>10. ຊັບສິນອື່ນໆ</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate2(data[month].Capital16, data[month].Capital2_16_7, data[month].debt2, data[month].assets8, data[month].loans5, data[month].otherAssets10);
                                    ...
                                    rows.assets8 += `<td>${numberFormat(data[month].assets8*(100/100))}</td>`;
                                    rows.loans5 += `<td>${numberFormat(data[month].loans5*(100/100))}</td>`;
                                    rows.otherAssets10 += `<td>${numberFormat(data[month].otherAssets10*(100/100))}</td>`;
