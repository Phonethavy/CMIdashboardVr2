...
if (isset($_GET['startdate']) && isset($_GET['enddate'])) {
        ...
        {
                $goal_query = "SELECT  
        SUM(CASE WHEN code_kpi = 'KPI1' THEN tbl_kpi_goal.Goal ELSE 0 END) AS KPI1,
        SUM(CASE WHEN code_kpi = 'KPI2' THEN tbl_kpi_goal.Goal ELSE 0 END) AS KPI2,
        SUM(CASE WHEN code_kpi = 'KPI3' THEN tbl_kpi_goal.Goal ELSE 0 END) AS KPI3,
         FORMAT(SUM(CASE WHEN code_kpi = 'KPI4' THEN tbl_kpi_goal.Goal ELSE 0 END), 2) AS KPI4
    FROM tbl_kpi_goal
    WHERE YEAR(date_dim) = ?";
...
FORMAT(SUM(CASE 
       ...
       '510131200100000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS interest_income_from_bank0,
FORMAT(SUM(CASE 
        WHEN account_no IN (
...
FORMAT(SUM(CASE 
       ...
       '510287000200003'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_public_loan16,
FORMAT(SUM(CASE 
        WHEN account_no IN (
       '510287000300003'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_public_loan14,
FORMAT(SUM(CASE 
        WHEN account_no IN (
       '510287000400003'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_public_loan17,
FORMAT(SUM(CASE 
        WHEN account_no IN (
       '510287000500003'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_public_loan15,
FORMAT(SUM(CASE 
        WHEN account_no IN (
      '510287000021000',
'510287000220000',
...
'510287000223000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_deposit16,
FORMAT(SUM(CASE 
        WHEN account_no IN (
     '510287000321000',
'510287000322000',
'510287000323000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_deposit14,
FORMAT(SUM(CASE 
        WHEN account_no IN (
     '510287000421000',
'510287000422000',
'510287000423000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_deposit17,
FORMAT(SUM(CASE 
        WHEN account_no IN (
    '510287000521000',
'510287000522000',
'510287000523000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) AS fee_on_deposit15,
...
'510287000223000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) fee_on_deposit16,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'510287000321000',
'510287000322000',
'510287000323000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) fee_on_deposit14,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'510287000421000',
'510287000422000',
'510287000423000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) fee_on_deposit17,
        FORMAT(SUM(CASE 
        WHEN account_no IN (
'510287000521000',
'510287000522000',
'510287000523000'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) fee_on_deposit15,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'570500000200000',
'570500000200001',
...
'570500000200004'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) NPL_income16,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'570500000300000',
'570500000300001',
...
'570500000300007'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) NPL_income14,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'570500000400000',
'570500000400001',
...
'570500000400007'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) NPL_income17,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'570500000500000',
'570500000500001',
...
'570500000500007'
        ...
        THEN tbl_atc.amount_money ELSE 0 END), 2) NPL_income15,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'550840000100000'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) Operation_income0,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'550840000200000'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) Operation_income16,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'550840000300000'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) Operation_income14,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'550840000400000'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) Operation_income17,
FORMAT(SUM(CASE 
        WHEN account_no IN (
'550840000500000'
        ) 
        THEN tbl_atc.amount_money ELSE 0 END), 2) Operation_income15
        FROM tbl_atc
    ...
    WHERE 
       `date` BETWEEN ? AND ? ";
        ...
        $counthkpi3 = "SELECT COUNT(*) as kpi3 FROM `kpi3` WHERE `date` BETWEEN ? AND ?";
