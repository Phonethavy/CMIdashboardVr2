    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນການລ້າງໜີ້ສູນ: ຍອດເງີນກູ້ທີ່ຕິດຕາມນອກຜັງ / ຍອດເງິນກູ້ທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ</td>
        ...
        <script>
            function calculate16(interest16, outstanding05, outstangding16) {
                ...
                return denominator ? (((outstangding16 + interest16) / denominator) * 100).toFixed(2) : "";
            }
            ...
            function createChart(labels, data1, data2) {
                ...
                financialChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: labels,
                        datasets: [{
                                label: 'ອັດຕາສ່ວນການລ້າງໜີ້ສູນ: ຍອດເງີນກູ້ທີ່ຕິດຕາມນອກຜັງ / ຍອດເງິນກູ້ທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ',
                                data: data2,
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate16(interest16, outstanding05, outstangding16);
                            roeData.push(roe);
                            labels.push(month);
                    ...
                    if (selectedYear) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    interest16: `<tr><td> ຍອດເຫຼືອດອກເບ້ຍ write off </td>`,
                                    outstanding05: `<tr><td>ຍອດເຫຼືອເງິນກູ້</td>`,
                                    outstangding16: `<tr><td>ຍອດເຫຼືອເງິນກູ້  write off</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate16(data[month].interest16, data[month].outstanding05, data[month].outstangding16);
