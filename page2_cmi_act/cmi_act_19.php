        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນທັງໝົດ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</td>
                    <td data-label="Goal">5%</td>
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate19(interest16, outstanding05, outstangding16);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate19(data[month].interest16, data[month].outstanding05, data[month].outstangding16);
