    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນເງິນກູ້ທັງໝົດຕໍ່ຊັບສີນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</td>
                    <td data-label="Goal">80%</td>
        ...
        <script>
            function calculate11(loan_balance99, All_propertyI) {
                ...
                return denominator ? ((loan_balance99 / denominator) * 100).toFixed(2) : "";
            }
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate11(loan_balance99, All_propertyI);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    ...
                                    All_propertyI: `<tr><td>I. ຊັບສິນທັງໝົດ</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate11(data[month].loan_balance99, data[month].All_propertyI);
