    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ສະພາບຄ່ອງ 1: ເງີນສົດໃນມື / ເງີນຝາກທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</td>
        ...
        <script>
            function calculate12(cash1_1_1, Debt11, deptsentcus12) {
                ...
                return denominator ? ((cash1_1_1 / denominator) * 100).toFixed(2) : "";
            }
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate12(cash1_1_1, Debt11, deptsentcus12);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    ...
                                    Debt11: `<tr><td>11. ໜີ້ຕ້ອງສົ່ງໃຫ້ທະນາຄານ ແລະ ສະຖາບັນການເງິນອື່ນ</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate12(data[month].cash1_1_1, data[month].Debt11, data[month].deptsentcus12);


                                    rows.cash1_1_1 += `<td>${numberFormat(data[month].cash1_1_1)}</td>`;
                                    rows.Debt11 += `<td>${numberFormat(data[month].Debt11)}</td>`;
