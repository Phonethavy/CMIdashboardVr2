        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ລູກຄ້າລາຍໃຫຍ່ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</td>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate17(data[month].interest16, data[month].Capital16);


                                    rows.interest16 += `<td>0</td>`;
