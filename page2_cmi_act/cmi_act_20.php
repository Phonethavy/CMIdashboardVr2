    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</td>
                    <td data-label="Goal">1%</td>
        ...
        <script>
            function calculate20(interest16, outstanding05, outstangding16) {
                ...
                return denominator ? (((0) / denominator) * 100).toFixed(2) : "";
            }
            ...
            function createChart(labels, data1, data2) {
                ...
                financialChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: labels,
                        datasets: [{
                                label: 'ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ',
                                data: data2,
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate20(interest16, outstanding05, outstangding16);
                            roeData.push(roe);
                            labels.push(month);
                    ...
                    if (selectedYear) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    interest16: `<tr><td>ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນທັງໝົດ</td>`,
                                    outstanding05: `<tr><td>16. ທຶນ ແລະ ຖືວ່າເປັນທຶນຂອງສະຖາບັນການເງິນ</td>`,
                                    outstangding16: `<tr><td>16. ທຶນ ແລະ ຖືວ່າເປັນທຶນຂອງສະຖາບັນການເງິນ</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate20(data[month].interest16, data[month].outstanding05, data[month].outstangding16);
                                    rows.interest16 += `<td>${numberFormat(data[month]. interest16)}</td>`;
                                    rows.outstanding05 += `<td>${numberFormat(data[month].outstanding05)}</td>`;
                                    rows.outstangding16 += `<td>${numberFormat(data[month]. outstangding16)}</td>`;
