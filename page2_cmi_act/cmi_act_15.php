    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນໜີ້ທວງຍາກ: ເງິນກູ້ຊ້າເກີນ 60ວັນ /ຍອດເງິນກູ້ທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</td>
        ...
        <script>
            function calculate15(loan_balanceCDE, loan_balance99) {
                ...
                return denominator ? ((loan_balanceCDE / denominator) * 100).toFixed(2) : "";
            }
            ...
            function createChart(labels, data1, data2) {
                ...
                financialChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: labels,
                        datasets: [{
                                label: 'ອັດຕາສ່ວນໜີ້ທວງຍາກ: ເງິນກູ້ຊ້າເກີນ 60ວັນ /ຍອດເງິນກູ້ທັງໝົດ ຕ້ອງນ້ອຍກວ່າ',
                                data: data2,
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate15(loan_balanceCDE, loan_balance99);
                            roeData.push(roe);
                            labels.push(month);
                    ...
                    if (selectedYear) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var rows = {
                                    loan_balanceCDE: `<tr><td>ຍອດເຫຼືອເງິນກູ້ຊັ້ນ CDE</td>`,
                                    loan_balance99: `<tr><td>ຍອດເຫຼືອເງິນກູ້</td>`,
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate15(data[month].loan_balanceCDE, data[month].loan_balance99);


                                    rows.loan_balanceCDE += `<td>${numberFormat(data[month].loan_balanceCDE)}</td>`;
                                    rows.loan_balance99 += `<td>${numberFormat(data[month].loan_balance99)}</td>`;
