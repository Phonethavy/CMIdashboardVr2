...
<body>
    ...
    <div class="container mt-4">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_1.php"> ອັດຕາສ່ວນທຶນທັງໝົດ / ຊັບສິນທີ່ວາງນ້ຳໜັກຄວາມສ່ຽງ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_2.php">ອັດຕາສ່ວນທຶນຊັ້ນໜຶ່ງ / ຊັບສີນທີ່ວາງນ້ຳໜັກຄວາມສ່ຽງ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_3.php">ອັດຕາສ່ວນຜົນຕອບແທນຈາກທຶນ ROE ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_4.php">ອັດຕາສ່ວນຜົນຕອບແທນຈາກຊັບສີນ ROA ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_5.php">ການກູ້ຢືມ: ການກູ້ຍືມຈາກພາຍນອກທັງໝົດ / ຍອດສີນເຊື່ອທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_6.php">ການລົງທຶນ: ເງິນລົງທືນທັງໝົດ / ທຶນຈົດທະບຽນ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_7.php">ອັດຕາສ່ວນການລະດົມເງິນຝາກ (ເງິນຝາກທັງໝົດ / ທືນຊັ້ນໜຶ່ງ ) ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_8.php">ອັດຕາສ່ວນດອກເບ້ຍສຸດທິ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_9.php">ການກຸ້ມຕົນເອງໃນການດຳເນີນງານ OSS ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_10.php">ອັດຕາສ່ວນການລົງທຶນເງິນຝາກທັງໝົດ / ທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</a>
                <td id="goal-cell10">10%</td>
                <td id="ratio-value-cell10">-</td>
                <td id="status-cell10" style="color: black;">-</td>
            </tr>
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_11.php">ອັດຕາສ່ວນເງິນກູ້ທັງໝົດຕໍ່ຊັບສີນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_12.php">ສະພາບຄ່ອງ 1: ເງີນສົດໃນມື / ເງີນຝາກທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_13.php">ສະພາບຄ່ອງ 2: (ເງິນສົດໃນມື+ເງິນຝາກຢູ່ສະຖາບັນອື່ນ) / ໜີ້ສີນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_14.php">ອັດຕາສ່ວນຊັບສີນຄ່ອງຕົວ ( ເງິນສົດແລະເງິນທ/ຄ ທີ່ສາມາດຖອນໄດ້ ) / ຊັບສິນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_15.php">ອັດຕາສ່ວນໜີ້ທວງຍາກ: ເງິນກູ້ຊ້າເກີນ 60ວັນ /ຍອດເງິນກູ້ທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_16.php">ອັດຕາສ່ວນການລ້າງໜີ້ສູນ: ຍອດເງີນກູ້ທີ່ຕິດຕາມນອກຜັງ / ຍອດເງິນກູ້ທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_17.php">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ລູກຄ້າລາຍໃຫຍ່ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_18.php">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ລູກຄ້າໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_19.php">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນທັງໝົດ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_20.php">ອັດຕາສ່ວນສິນເຊື່ອໃຫ້ແກ່ພາກສ່ວນທີ່ມີສາຍພົວພັນໜຶ່ງລາຍ / ທຶນທັງໝົດ ຕ້ອງນ້ອຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_21.php">ອັດຕາສ່ວນຄວາມພຽງພໍຂອງການຫັກເງິນແຮສິນເຊື່ອທີ່ຖືກຈັດຊັ້ນ / ເງິນແຮທັງໝົດທີ່ຕ້ອງສ້າງຕາມລະບຽບ ຕ້ອງຫຼາຍກວ່າ</a>
                </td>
            ...
            <tr>
                <td><a style="text-decoration:none ;color:rgb(0, 0, 0);" href="../page2_cmi_act/cmi_act_22.php">ອັດຕາສ່ວນປະສິດທິພາບດ້ານການດຳເນີນງານ ຕ້ອງນ້ອຍກວ່າ
                    </a>
                </td>
    ...
    <script>
        ...
        $.ajax({
            url: `../ajx_json/act_db.php?year1=${currentYear}&year2=${currentYear - 1}&month=${previousMonth}`,
            method: 'GET',
            dataType: 'json',
