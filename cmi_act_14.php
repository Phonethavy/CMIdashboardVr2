        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນຊັບສີນຄ່ອງຕົວ ( ເງິນສົດແລະເງິນທ/ຄ ທີ່ສາມາດຖອນໄດ້ ) / ຊັບສິນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ</td>
            ...
            function createChart(labels, data1, data2) {
                ...
                financialChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: labels,
                        datasets: [{
                                label: 'ອັດຕາສ່ວນຊັບສີນຄ່ອງຕົວ ( ເງິນສົດແລະເງິນທ/ຄ ທີ່ສາມາດຖອນໄດ້ ) / ຊັບສິນທັງໝົດ ຕ້ອງຫຼາຍກວ່າ',
                                data: data2,
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate14(All_propertyI, cash1_1_1, debt2);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate14(data[month].All_propertyI, data[month].cash1_1_1, data[month].debt2);
