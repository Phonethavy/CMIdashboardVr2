    ...
    document.getElementById('searchForm').addEventListener('submit', function(event) {
     ...
     <body>
         ...
         <main>
             ...
             <section class="stats">
                 <div class="stat-item">
                     <a href="kpi1.php"><i class="fas fa-wallet"></i></a>
                 ...
                 <div class="stat-item">
                     <a href="kpi2.php"><i class="fas fa-money-bill-wave"></i></a>
                     <div class="border-01"></div>
                     <h3>ລາຍຮັບອື່ນໆ</h3>
                     <h1>ເປົ້າໝາຍ</h1>
                 ...
                 <div class="stat-item">
                     <a href="kpi3.php"><i class="fas fa-users"></i></a>
                     <div class="border-01"></div>
                     <h3>ລູກຄ້າ</h3>
                     <h1>ເປົ້າໝາຍ</h1>
                 ...
                 <div class="stat-item">
                     <a href="kpi4.php"><i class="fas fa-chart-line"></i></a>
                     <div class="border-01"></div>
