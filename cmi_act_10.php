    ...
    <div class="container mt-4">
        ...
        <table class="table1" id="data-table">
            ...
            <tbody>
                <tr id="calculated-ratio-row">
                    <td style="padding: 5px 0px;text-align: left;" data-label="Data Type">ອັດຕາສ່ວນຊັບສົມບັດຄົງທີ່: ຊັບສົມບັດຄົງທີ່ສຸດທິຫັກຄ່າຫຼຸ້ຍຫ້ຽນແລ້ວ / ຊັບສີນທັງໝົດສະເລ່ຍ ຕ້ອງນ້ອຍກວ່າ</td>
        ...
        <script>
            function calculate10(assets8, All_propertyI) {
                ...
                return denominator ? ((assets8 / denominator) * 100).toFixed(2) : "";
            }
                ...
                $('#fetch-data').on('click', function() {
                    ...
                    Promise.all(promises).then(() => {
                        ...
                        Object.keys(fetchedData).forEach(month => {
                            ...
                            const roe = calculate10(assets8, All_propertyI);
                            roeData.push(roe);
                            labels.push(month);
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                for (var month in data) {
                                    ...
                                    var ratio = calculate10(data[month].assets8, data[month].All_propertyI);
